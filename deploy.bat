...
if not exist "%DST_DEBUG%\Contents\Resources\breathalyzer.uidesc" (
  echo Debug deploy failed: missing %DST_DEBUG%\Contents\Resources\breathalyzer.uidesc
  goto :done
)
...
if not exist "%DST_RELEASE%\Contents\Resources\breathalyzer.uidesc" (
  echo Release deploy failed: missing %DST_RELEASE%\Contents\Resources\breathalyzer.uidesc
  goto :done
)
